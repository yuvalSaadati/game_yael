    ...
    const hardSystems = [
        {
            ...
            options: [
                ...
                { text: "תחנות אחרות יכולות לפצות על החסר בעומס נוסף, אך יתכנו הפסקות חשמל זמניות באזורים מסוימים", isCorrect: true },
        ...
        },
        {
            ...
            options: [
                { text: "אין השפעה על שאר הגוף כי כל איבר פועל באופן עצמאי", isCorrect: false },
                { text: "הגוף מיד מפסיק לתפקד לחלוטין", isCorrect: false },
                { text: "הגוף מפתח התאמות זמניות: שינוי בצורת ההליכה, עומס נוסף על הרגל השנייה, ושימוש בשרירי פלג גוף עליון", isCorrect: true },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "הפרויקט בהכרח ייכשל ויתבטל", isCorrect: false },
                { text: "רק המטלות הספציפיות של אותו חבר צוות יושפעו", isCorrect: false },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "נהיגה בכל העיר נעצרת לחלוטין", isCorrect: false },
                { text: "נוצרים עומסי תנועה בדרכים חלופיות ומשתנים דפוסי הנסיעה בכל האזור", isCorrect: true },
                { text: "רק האנשים שרצו לנסוע באותו כביש מושפעים", isCorrect: false }
            ],
        ...
        },
        {
            ...
            options: [
                { text: "כדי לחסוך בדלק", isCorrect: false },
                { text: "כדי שהמטוס יוכל להמשיך לטוס בבטחה גם אם אחת המערכות נכשלת", isCorrect: true },
                { text: "רק כדי לעמוד בתקנות, אין להן שימוש אמיתי", isCorrect: false },
